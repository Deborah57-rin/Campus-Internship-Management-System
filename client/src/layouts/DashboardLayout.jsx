    ...
    <div className="flex h-full flex-col">
      <div className="flex items-center gap-3 px-5 py-5">
        <button
          ...
          className="flex items-center gap-3 rounded-xl px-2 py-2 text-left hover:bg-slate-50 focus:outline-none focus:ring-4 focus:ring-usiu-navy/10"
        >
          <span className="grid h-10 w-10 place-items-center rounded-xl bg-usiu-navy/10 text-usiu-navy ring-1 ring-usiu-navy/15">
            ...
            <NavLink
              ...
              className={() => {
                ...
                return classNames(
                  ...
                  active
                    ? 'bg-usiu-navy text-white shadow-sm'
      ...
      <div className="mt-auto border-t border-slate-200 p-4">
        <div className="flex items-center justify-between gap-3 rounded-xl bg-slate-50 px-3 py-3 ring-1 ring-slate-200">
          ...
          <button
            ...
            className="inline-flex items-center gap-2 rounded-lg bg-white px-3 py-2 text-xs font-semibold text-slate-700 ring-1 ring-slate-200 transition hover:bg-slate-100 focus:outline-none focus:ring-4 focus:ring-usiu-red/15"
          >
            <LogOut className="h-4 w-4 text-usiu-red" />
            Logout
          </button>
        </div>
      </div>
        ...
        <header className="sticky top-0 z-30 border-b border-slate-200 bg-white/80 backdrop-blur">
          <div className="flex items-center justify-between px-4 py-4 sm:px-6 lg:px-8">
            ...
            <div className="hidden sm:flex items-center gap-2">
              <span className="rounded-full bg-usiu-navy/10 px-3 py-1 text-xs font-semibold text-usiu-navy ring-1 ring-usiu-navy/15">
